...
class OrthodonticPhotograph(PhotographBase):
    ...
    def __init__(self, **kwargs):
        ...
        # TODO: this hardcoding might not be ideal here. But for all orthodontic photography purposes that i am aware of, this is always DSC. These could come from EXIF. See https://dicom.nema.org/medical/dicom/current/output/chtml/part17/chapter_NNNN.html but they might not. The code here should 
